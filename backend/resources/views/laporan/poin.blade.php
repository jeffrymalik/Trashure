...
<head>
    <meta charset="utf-8">
    <title>Laporan Penukaran Poin</title>
    <style>
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->voucher->nama_voucher ?? '-' }}</td>
    ...
    <div class="summary">
        <p><strong>Total Penukaran:</strong> {{ $data->count() }}</p>
        <p><strong>Total Poin Digunakan:</strong> {{ $totalPoin }} poin</p>
    </div>
    <div class="footer">
